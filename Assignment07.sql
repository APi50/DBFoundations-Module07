...
-- 2017-01-01,APirio,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_APirio')
	 Begin 
	  Alter Database [Assignment07DB_APirio] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_APirio;
	 End
	Create Database Assignment07DB_APirio;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_APirio;
...
go
Select vProducts.ProductName, UnitPrice = Format(vProducts.UnitPrice, 'C', 'en-us')
from vProducts
order by 1;
go
...
go
Select vCategories.CategoryName, vProducts.ProductName, UnitPrice = Format(vProducts.UnitPrice, 'C', 'en-us')
from vCategories
